...
// FinancialInstitutionIdentification185: Legal entity identifier of the financial institution.
#[derive(Debug, Default, Serialize, Deserialize, Clone, PartialEq)]
...
pub struct Party44Choice1 {
    ...
    pub fi_id: Option<BranchAndFinancialInstitutionIdentification66>,
}

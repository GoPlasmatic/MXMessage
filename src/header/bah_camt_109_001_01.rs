...
pub struct BusinessApplicationHeaderV02 {
    ...
    pub msg_def_idr: String,
    #[serde(rename = "BizSvc")]
    pub biz_svc: UsageIdentifierPatternTextfixed,
...
// UsageIdentifierPatternText_fixed: swift.cbprplus.03
#[derive(Debug, Default, Serialize, Deserialize, Clone, PartialEq)]
pub enum UsageIdentifierPatternTextfixed {
    #[default]
    #[serde(rename = "swift.cbprplus.03")]
    CodeSWIFTCBPRPLUS03,
}

impl UsageIdentifierPatternTextfixed {
    pub fn validate(&self) -> Result<(), ValidationError> {
        Ok(())
    }
}

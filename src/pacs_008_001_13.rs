...
pub struct AdditionalDateTime1 {
	...
	#[serde(rename = "XpryDtTm", skip_serializing_if = "Option::is_none")]
	pub xpry_dt_tm: Option<String>,
}
...
pub struct CreditTransferTransaction70 {
	...
	#[serde(rename = "AddtlDtTm", skip_serializing_if = "Option::is_none")]
	...
	#[serde(rename = "AgrdRate", skip_serializing_if = "Option::is_none")]
	...
	#[serde(rename = "PmtSgntr", skip_serializing_if = "Option::is_none")]
	pub pmt_sgntr: Option<CryptographicKey1Choice>,
...
impl CreditTransferTransaction70 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.addtl_dt_tm { val.validate()? }
		if let Some(ref val) = self.instd_amt { val.validate()? }
		if let Some(ref val) = self.agrd_rate { val.validate()? }
		...
		if let Some(ref val) = self.pmt_sgntr { val.validate()? }
...
pub struct CryptographicKey1Choice {
	#[serde(rename = "ILPV4", skip_serializing_if = "Option::is_none")]
	pub ilpv4: Option<String>,
	#[serde(rename = "Sgntr", skip_serializing_if = "Option::is_none")]
	pub sgntr: Option<String>,
}

impl CryptographicKey1Choice {
	pub fn validate(&self) -> Result<(), ValidationError> {
		if let Some(ref val) = self.ilpv4 {
			let pattern = Regex::new("[0-9a-fA-F]+").unwrap();
			if !pattern.is_match(val) {
				return Err(ValidationError::new(1005, "ilpv4 does not match the required pattern".to_string()));
			}
		}
		if let Some(ref val) = self.sgntr {
			let pattern = Regex::new("([0-9A-F][0-9A-F]){32}").unwrap();
			if !pattern.is_match(val) {
				return Err(ValidationError::new(1005, "sgntr does not match the required pattern".to_string()));
			}
		}
		Ok(())
	}
...
pub struct CurrencyExchange26 {
	...
	pub qtd_ccy: Option<String>,
	#[serde(rename = "PreAgrdXchgRate")]
	pub pre_agrd_xchg_rate: f64,
	#[serde(rename = "QtnDtTm", skip_serializing_if = "Option::is_none")]
	pub qtn_dt_tm: Option<String>,
	#[serde(rename = "QtId", skip_serializing_if = "Option::is_none")]
	pub qt_id: Option<String>,
	#[serde(rename = "FXAgt", skip_serializing_if = "Option::is_none")]
...
impl CurrencyExchange26 {
	pub fn validate(&self) -> Result<(), ValidationError> {
		...
		if let Some(ref val) = self.qt_id {
			...
			if !pattern.is_match(val) {
				return Err(ValidationError::new(1005, "qt_id does not match the required pattern".to_string()));
			}
		}
		if let Some(ref val) = self.fx_agt { val.validate()? }
		Ok(())
	}
}
